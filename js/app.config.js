...
window.APP_CONFIG = {
  ...
  TABLES: { profiles:"profiles", children:"children", measurements:"measurements", meals:"meals", meal_items:"meal_items", targets:"targets", rewards_points_ledger:"rewards_points_ledger", shares:"share_access" },
  COLUMNS: {
    children: { id:"id", name:"display_name", unit:"unit" },
